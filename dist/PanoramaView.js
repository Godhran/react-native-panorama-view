...
exports.PanoramaView = function (_a) {
    var onImageLoadingFailed = _a.onImageLoadingFailed, onImageLoading= _a.onImageLoading, onImageLoaded = _a.onImageLoaded, dimensions = _a.dimensions, inputType = _a.inputType, props = __rest(_a, ["onImageLoadingFailed", "onImageLoaded", "dimensions", "inputType"]);
    ...
    return (<NativePanoramaView {...props} dimensions={dimensions} inputType={inputType} onImageLoaded={_onImageLoaded}  onImageLoading={_onImageLoading()} onImageLoadingFailed={_onImageLoadingFailed}/>);
};
